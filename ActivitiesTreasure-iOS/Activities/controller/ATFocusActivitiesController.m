//
//  ATFriendActivitiesController.m
...
@interface ATFocusActivitiesController ()

@end

@implementation ATFocusActivitiesController


static ATFocusActivitiesController *shareFriendAcitivitiesController = nil;
+(ATFocusActivitiesController *)sharedController{
    @synchronized(self){
